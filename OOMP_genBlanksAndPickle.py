...
######  All but labels
OOMPgenerate.generateAll(filter =filter,labels=False,scads=True,renders=True,readmes=True,diagrams=False,diagRenders=True,images=True,overwrite=False)
######  Labels
OOMPgenerate.generateAll(filter =filter,labels=True,scads=False,renders=False,readmes=False,diagrams=False,diagRenders=False,images=False,overwrite=False,json=True)
######  Readmes
