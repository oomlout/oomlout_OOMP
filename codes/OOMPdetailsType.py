...
OOMP.oompAddDetail(category="type",code="DCPP",name="DC Plug")
...
OOMP.oompAddDetail(category="type",code="HEAS",name="Header (Socket)")
...
OOMP.oompAddDetail(category="type",code="MOTV",name="Motor (Vibrating)")
...
OOMP.oompAddDetail(category="type",code="PIEZ",name="Piezo Element")
...
OOMP.oompAddDetail(category="type",code="SERV",name="Servo")
...
OOMP.oompAddDetail(category="type",code="TINB",name="Tin Box")
