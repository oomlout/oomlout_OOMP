// Generated by SolidPython 1.1.3 on 2022-06-05 15:59:35
$fn = 120;
						...
						translate(v = [1.2700000000, 0, 0.1000000000]) {
							rotate(a = [0, 0, 0]) {
								color(alpha = 1.0000000000, c = "gray") {
									translate(v = [0, 0, 0]) {
										rotate(a = [0.6000000000, 0.6000000000, 100]) {
...
def saveToScad(fileName, parts):
    file_out = scad_render_to_file(parts, fileName, file_header=f'$fn = 120;')
